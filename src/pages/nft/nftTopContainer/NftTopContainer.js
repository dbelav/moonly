...
const NftTopContainer = ({nftStats, nftDescribe, nftChartLoading, nftChart}) =>{
    ...
    console.log(nftDescribe)

    const renderChart = nftChartLoading ? null : <NftChart nftChart={nftChart}/>
            ...
            <div className='nftTopContainerFirst'>
                ...
                <div className='nftTopContainerFirstLinks'>
                    ...
                    <div className='nftTopContainerFirstLinksME'>
                        <a href={`https://magiceden.io/marketplace/${nftDescribe.symbol}`}>Magic Eden</a>
                    </div>
                </div>
            ...
            <div className='nftTopContainerSecond'>
                <div className='nftTopContainerSecondInfo'>
                    ...
                    <div className='nftTopContainerSecondInfoDate nftTopContainerItem'>
                        <h3>Mint date</h3>
                        <span>{nftDescribe.createdAt ? nftDescribe.createdAt.substring(0,10) : null}</span>
                    </div>
                </div>
                ...
                <div className='nftTopContainerSecondInfo nftTopContainerSecondInfoBottom'>
                    <div className='nftTopContainerSecondInfoFloor nftTopContainerItem'>
                        <h3>Floor price</h3>
                        <span>{(nftStats.results.floorPrice/ 1000000000).toFixed(2)}</span>
                    </div>
                    <div className='nftTopContainerSecondInfoSupplyVolume nftTopContainerItem'>
                        <h3>Volume</h3>
                        <span>{(nftStats.results.volumeAll / 1000000000000).toFixed(2) + 'K'}</span>
                    </div>
